...
public class MemberRepository {
    ...
    public boolean createMember(
        ...
        try {
            insertMember(memberID, fullName, dateOfBirth, phoneNumber);
        ...
        return publicKey != null && updatePublicKey(memberID, publicKey);
    }
    ...
    private boolean updatePublicKey(@NotNull String memberID, @NotNull PublicKey publicKey) {
        try {
            database.executeUpdate(
                "UPDATE `members` "
                    + "SET `public_key` = '" + toHexString(publicKey.getEncoded()) + "' "
